...
include_once(BASE_PATH . '/product_card.php');
?>
...
<head>
    ...
    overflow: hidden;
    width: 30%; /* Compact width suitable for all elements */
...
.product-image {
    position: relative;
    overflow: hidden;
    height: 150px; /* Balanced height for compact design */
}
...
function filterCategoryProduct()
{
    ...
    if (isset($_GET['category'])) {
        ...
        <div class='one-card'>
            <div class='photo'>
                <img src='/PrimeTextiles/assets/images/products/$product_image_one' alt='$product_title'>
                <button>
        ...
        if (!isset($_GET['category'])) {
            if (!isset($_GET['brand'])) {
                ...
                while ($row = mysqli_fetch_assoc($select_product_result)) {
                    ...
                    $product_image_one = $row['product_image_one'] ? $row['product_image_one'] : 'default-product.jpg';
                    $product_image_two = $row['product_image_two'] ? $row['product_image_two'] : 'default-product.jpg';
                    $product_image_three = $row['product_image_three'] ? $row['product_image_three'] : 'default-product.jpg';
                    $product_price = $row['product_price'];
                    $category_id = $row['category_id'];
                    $brand_id = $row['brand_id'];
                    echo "
                    ...
                    <div class='col-md-2'>
                        <div class='prod-imgs'>
                            ...
                            <img src='./assets/images/products/$product_image_two' alt='$product_title'>
                            <img src='./assets/images/products/$product_image_three' alt='$product_title'>
                        </div>
                    </div>
                    <div class='col-md-5'>
                        <div class='main-img'>
                    ...
                    <div class='col-md-5'>
                        <div class='info d-flex flex-column gap-2'>
                            ...
                            <h4 id='price-value' class='price-value'>
...
<form action='products.php?add_to_cart=<?php echo $product_id; ?>' method='post'>
    <div class='buy-item d-flex gap-3 justify-content-center align-items-center'>
        <div class='num-btns d-flex gap-1'>
            ...
            <input type='number' class='form-control quantity-input' name='num_of_items' id='num_of_items' value='1'>
        ...
        <div>
            <input type='submit' class='btn btn-primary' value='Buy Now'>
                            ...
                            <script>
    var singleItemPrice = " . json_encode((float)$product_price) . ";
</script>
